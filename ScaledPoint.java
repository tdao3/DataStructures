...
public class ScaledPoint
{
    ...
    public int getMin()
    // PRE:  windowHeight/Width are updated to the current height of the window
    //       where this pixel value is being used to paint.
    {
        // in order to stay scaled to the smaller side of the window
        return Math.min((int)(y * windowHeight), (int)(x * windowWidth));
    }
}
